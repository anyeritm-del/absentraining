...
export default function AbsenLinkCard() {
  ...
  return (
    <div className="flex flex-col items-center gap-3 rounded-xl border border-zinc-200 bg-white p-5 text-center dark:border-zinc-800 dark:bg-zinc-900 sm:flex-row sm:items-center sm:text-left">
      {qrDataUrl && (
        // eslint-disable-next-line @next/next/no-img-element
        <img src={qrDataUrl} alt="QR link absen" width={140} height={140} className="print:hidden" />
      )}
