    ...
    <div className="flex flex-1 items-center justify-center bg-zinc-50 px-4 dark:bg-black">
      ...
      >
        ...
        <p className="mb-6 text-sm text-zinc-500">
          Masuk untuk mengelola department, jadwal, dan data anak training.
        </p>
        ...
        <input
          ...
          className="mb-4 w-full rounded-md border border-zinc-300 px-3 py-2 text-sm outline-none focus:border-zinc-500 dark:border-zinc-700 dark:bg-zinc-800"
        />
